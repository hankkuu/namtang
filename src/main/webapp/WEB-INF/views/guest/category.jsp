                            ...
                            <form action="#">
                                <ul id="category">
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="0" name="catg"
                                                                   checked><label
                                            for="0">전체보기<span> (${list[10]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="1"
                                                                   name="catg"><label
                                            for="1">한국시<span> (${list[0]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="2"
                                                                   name="catg"><label
                                            for="2">외국시<span> (${list[1]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="3"
                                                                   name="catg"><label for="3">인물
                                        에세이<span> (${list[2]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="4"
                                                                   name="catg"><label for="4">여행
                                        에세이<span> (${list[3]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="5"
                                                                   name="catg"><label for="5">성공
                                        에세이<span> (${list[4]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="6"
                                                                   name="catg"><label for="6">독서
                                        에세이<span> (${list[5]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="7"
                                                                   name="catg"><label for="7">명상
                                        에세이<span> (${list[6]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="8"
                                                                   name="catg"><label for="8">그림/포토
                                        에세이<span> (${list[7]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="9"
                                                                   name="catg"><label for="9">연애/사랑
                                        에세이<span> (${list[8]})</span></label></li>
                                    <li class="filter-list"><input class="pixel-radio" type="radio" id="10" name="catg"><label
                                            for="10">삶의 지혜/명언<span> (${list[9]})</span></label></li>
                                </ul>
                            </form>
                        </li>
                    </ul>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    <div class="card-product__img">
                                        ...
                                        <ul class="card-product__imgOverlay">
                                            <li>
                                                <button id="BookDetail"><i class="ti-search"><a
                                                        hidden>${item.bookIdx}</a></i></button>
                                            </li>
                                            <li>
