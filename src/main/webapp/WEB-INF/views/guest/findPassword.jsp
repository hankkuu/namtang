  ...
  <title>Aroma Shop - Login</title>
	...
	<script type="text/javascript">
		...
		const purchaseProcess = async () => {
			...
			let user = {email: email, userId: userId}
			const result = await $.ajax({


				type: "post",
				url: "/api/v1/account/findPassword",
				dataType: "json",
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="#/" id="contactForm" >
							...
							<div class="col-md-12 form-group">
								<button type="button" value="submit" id="findPassword" class="button button-login w-100">비밀번호 찾기</button>
							</div>
						</form>
					</div>
				</div>
